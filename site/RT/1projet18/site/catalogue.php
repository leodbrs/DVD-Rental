...
<head>
    ...
    <link rel="shortcut icon" href="/RT/1projet18/site/assets/img/favicon.png" type="image/png">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel='stylesheet' type='text/css' media='screen' href='/RT/1projet18/site/styles/main.css'>
</head>

<body class='scrollinvisible'>
    <?php
    require_once($_SERVER['DOCUMENT_ROOT'] . "/RT/1projet18/site/includes/connexionBDD.php");
    $conn1 = connexionBDD();

    include($_SERVER['DOCUMENT_ROOT'] . "/RT/1projet18/site/includes/header.php");
    ?>
    ...
    <nav id='menu' style='height: 120%;'>
        <ul class='deroulant'>
            <li>
                ...
                <ul class='sousmenu'>
                    <li><a href="/RT/1projet18/site/catalogue.php?page=1">annuler la sélection</a></li>
                    <?php
                    ...
                    ?>
                        <li><a href="/RT/1projet18/site/catalogue.php?page=1&idgenre=<?= $ligne['idgenre'] ?>"><?= $ligne['nomgenre'] ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </li>
        </ul>
    ...
    <section id="corps_paddingleft">
        ...
        ?>
                <center>
                    ...
                    <div>
                        <a class="film" href="/RT/1projet18/site/catalogue.php?page=1"><button>retour</button></a>
                    </div>
                </center>
            ...
            ?>
                <div class="row">
                    ...
                    foreach ($listFilm as $ligne) : ?>
                        <div class="card">
                            <?php echo '<img class="card img" src="/RT/1projet18/site/upload/' . $ligne['image'] . '" alt="Image non chargée" style="width:100%">' ?>
                            <h2><?php echo $ligne['titrefilm'] ?></h2>
                            <p><a href="/RT/1projet18/site/includes/film.php/?id_film=<?= $ligne['idfilm'] ?>">
                ...
                <center>
                    <nav class="nav_catalogue">
                        <ul>
                            ...
                            <?php else : ?>
                                <li>
                                    <a href="/RT/1projet18/site/catalogue.php?page=<?= $currentPage - 1 ?><?php if (isset($_GET['idgenre']) && !empty($_GET['idgenre'])) {
                            ...
                            <?php for ($page = 1; $page <= $pages; $page++) : ?>
                                <li>
                                    <a href="/RT/1projet18/site/catalogue.php?page=<?= $page ?><?php if (isset($_GET['idgenre']) && !empty($_GET['idgenre'])) {
                                                                                                    echo "&idgenre=" . $localgenre;
                                                                                                } ?>"><?= $page ?></a>
                                </li>
                            <?php endfor; ?>
