...
$menuInscription = <<<EOT
<center>
    <form id='corps' method="POST" action="/RT/1projet18/site/inscription.php">
        <table>
...
<head>
    ...
    <script src='/RT/1projet18/site/scripts/inscription.js'></script>
</head>
    ...
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['date_naissance'], $_POST['genre'], $_POST['code_postal'], $_POST['ville'], $_POST['username'], $_POST['password'], $_POST['comfirme_password'])) {
        ...
        elseif (strlen($local_password) < 8) {
            ...
            if ($query->execute()) {
                ...
                // header('Location: /RT/1projet18/site/inscription.php');
