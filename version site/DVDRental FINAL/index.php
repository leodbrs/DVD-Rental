...
<body>
    <?php include($_SERVER['DOCUMENT_ROOT'] . "/RT/1projet18/site/includes/header.php"); ?>
    ...
    <center>
        <section id='corps'>
            ...
            <br><br>
            <a href="/RT/1projet18/site/catalogue.php" class="film"><button>Visiter le catalogue</button></a>
        </section>
    </center>
</body>
