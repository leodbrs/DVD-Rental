...
<head>
    ...
    <script src='/RT/1projet18/site/scripts/client.js'></script>
</head>
...
<!------------------------------------------------------ AFFICHAGE DU PANIER  ------------------------------------------------------------------------------>
    <center>
        ...
        <section id='corps'>
            ...
            <div class="film"><a href='/RT/1projet18/site/catalogue.php'><button>retour au catalogue</button></a></div><br>
            <div class="film"><a href='/RT/1projet18/site/panier.php/?validation=1'><button>valider la commande</button></a></div>
        </section>
    </center>
</body>