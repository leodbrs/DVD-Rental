...
if ($_SESSION['vendeur'] == 0) { // Si non vendeur, alors redirection index.php
    header('Location: /RT/1projet18/site/');
    ...
    if (isset($_GET['menu'])) {
        ...
        if (strpos($menu, 'client_list') !== false) {                                           // ########################### Lister les clients ###########################
            ...
            if (strpos($menu, 'film_edit_confirm') !== false) {
                ...
                $listeImage = array();
                // Recupere titre, description et image d'un film
                $directory = new DirectoryIterator($_SERVER['DOCUMENT_ROOT'] . "/RT/1projet18/site/upload");
                ...
                <form method='POST' enctype='multipart/form-data'>
                    <table>
                        ...
                        <td><img id='coverFilm' src='/RT/1projet18/site/upload/" . $liste[0]['image'] . "' alt='Image non chargée' style='height: 244px; width: 172px;'></td>
                        </tr>
                        <tr>
                            <td>Cover du film : </td>
                    ...
                    <form method=' POST' enctype='multipart/form-data'>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><img id='coverFilm' src='/RT/1projet18/site/assets/img/blanc.png' alt='' style='height: 244px; width: 172px;'></td>
                            </tr>
                            <tr>
                                <td>Cover du film : </td>
